...
Select Case Button
    ...
    Case vbRightButton
    CloseCon.Caption = "Close Connection by: " & Right(Connection(ListView1.SelectedItem.Tag).FileName, Len(Connection(ListView1.SelectedItem.Tag).FileName) - InStrRev(Connection(ListView1.SelectedItem.Tag).FileName, "\"))
    TermProg.Caption = "Terminate: " & Right(Connection(ListView1.SelectedItem.Tag).FileName, Len(Connection(ListView1.SelectedItem.Tag).FileName) - InStrRev(Connection(ListView1.SelectedItem.Tag).FileName, "\"))
    PopupMenu MenuPop
...
If hostname = "" Then
StatusBar.Panels(2).Text = "Unable to get Host Name"
Exit Sub
End If
...
StatusBar.Panels(2).Text = "Program Terminated: " & Right(Connection(ListView1.SelectedItem.Tag).FileName, Len(Connection(ListView1.SelectedItem.Tag).FileName) - InStrRev(Connection(ListView1.SelectedItem.Tag).FileName, "\"))
Else
StatusBar.Panels(2).Text = "Program Terminate Failed: " & Right(Connection(ListView1.SelectedItem.Tag).FileName, Len(Connection(ListView1.SelectedItem.Tag).FileName) - InStrRev(Connection(ListView1.SelectedItem.Tag).FileName, "\"))
End If
End Sub
...
StatusBar.Panels(3).Text = "Offline"
Exit Sub
Else
